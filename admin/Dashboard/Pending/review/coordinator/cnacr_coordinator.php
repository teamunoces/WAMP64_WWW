...
$reportType = isset($_GET['type']) ? htmlspecialchars($_GET['type']) : "Community Needs Assessment Consolidated Report";
                    ...
                    <textarea name="from_community" class="paper-lines" oninput="autoExpand(this)" rows="1" placeholder="Type here..."></textarea>
                      ...
                      <!--______________________________ footer___________________________ -->
                         ...
                         <footer>
                           ...
                           <!--______________________________ ADMIN COMMENT ___________________________ -->
                              ...
                              <!--______________________________ BUTTONS ___________________________ -->
