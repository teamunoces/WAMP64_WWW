...
async function handleResubmit() {
    ...
    try {
        ...
        const response = await fetch('/SYSTEM_VERSION_!/admin/ReportManagement/actions/admin_view/coor_cnacrview/update.php', {
            method: 'POST',
        ...
        if (result.success) {
            ...
            window.location.href = '/SYSTEM_VERSION_!/admin/Report/Reports.html';
        } else {
