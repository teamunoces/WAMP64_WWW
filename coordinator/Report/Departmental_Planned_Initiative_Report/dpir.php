       ...
       <header>
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="input-cell">
                <input type="text" name="department" id="department"  value="<?php echo htmlspecialchars($userDepartment); ?>" placeholder="Type here..." ></td>
                <td class="label-cell">Date Submitted</td>
                <td class="input-cell"><input type="text" name="date" id="date_submitted" value="<?php echo date('d-m-Y'); ?>" placeholder="Type here..." ></td>
            </tr>
        </table>
