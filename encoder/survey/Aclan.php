...
$barangay = isset($_GET['barangay']) ? htmlspecialchars($_GET['barangay']) : "aclan";
?>
<!DOCTYPE html>
<html lang="ceb">
<head>
...
<div class="container">
    ...
    <h2>Barangay Aclan, Nasipit, Agusan del Norte</h2>
    ...
    <section>
        ...
        <div class="checkbox-group">
            <label><input type="checkbox" name="district[]" value="Purok 1- Bougainvillea"> Purok 1- Bougainvillea</label>
            <label><input type="checkbox" name="district[]" value="Purok 2- Parpagayo"> Purok 2- Parpagayo</label>
            <label><input type="checkbox" name="district[]" value="Purok 3-Bitaog"> Purok 3-Bitaog</label>
            <label><input type="checkbox" name="district[]" value="Purok 4- Crusher"> Purok 4- Crusher</label>
            <label><input type="checkbox" name="district[]" value="Purok 5- Tabon"> Purok 5- Tabon</label>
        </div>
    </section>
